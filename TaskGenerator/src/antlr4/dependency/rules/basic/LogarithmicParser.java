...
public class LogarithmicParser extends Parser {
	...
	public LogarithmicParser(TokenStream input) {
		super(input);
	...
	public static class FormulaContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterFormula(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitFormula(this);
		}
	}
		...
		try {
			...
			setState(27); ((FormulaContext)_localctx).s = segmentSequence();
			        ...
			        if(((FormulaContext)_localctx).s.valid == true){
			            ((FormulaContext)_localctx).resultComplexity =  Complexity.createLog("n");
			        }
	...
	public static class SegmentSequenceContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterSegmentSequence(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitSegmentSequence(this);
		}
	}
	...
	public static class SegmentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterSegment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitSegment(this);
		}
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public TerminalNode LPAREN() { return getToken(LogarithmicParser.LPAREN, 0); }
		public TerminalNode COMMA() { return getToken(LogarithmicParser.COMMA, 0); }
		public RightSideContext rightSide() {
			return getRuleContext(RightSideContext.class,0);
		}
		public TerminalNode RPAREN() { return getToken(LogarithmicParser.RPAREN, 0); }
		public TerminalNode EXPR() { return getToken(LogarithmicParser.EXPR, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitExpression(this);
		}
	}
	...
	public static class LeftSideContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterLeftSide(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitLeftSide(this);
		}
	}
	...
	public static class RightSideContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterRightSide(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitRightSide(this);
		}
	}
	...
	public static class ArgListContext extends ParserRuleContext {
		...
		public List<TerminalNode> COMMA() { return getTokens(LogarithmicParser.COMMA); }
		public List<ArgContext> arg() {
			return getRuleContexts(ArgContext.class);
		}
		public TerminalNode COMMA(int i) {
			return getToken(LogarithmicParser.COMMA, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterArgList(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitArgList(this);
		}
	}
	...
	public static class ArgContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterArg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitArg(this);
		}
	}
	...
	public static class WhileSegmentContext extends ParserRuleContext {
		...
		public TerminalNode WHILE() { return getToken(LogarithmicParser.WHILE, 0); }
		public TerminalNode COMMA(int i) {
			return getToken(LogarithmicParser.COMMA, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterWhileSegment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitWhileSegment(this);
		}
	}
				...
				setState(83); ((WhileSegmentContext)_localctx).exprs = exprSequence();
			        ...
			        if(((WhileSegmentContext)_localctx).a.var.equals(((WhileSegmentContext)_localctx).b.var)){
			            ...
			            if(_localctx.numA==1 && _localctx.numB==0){
			                //a=a*k
			                try{
			                    unifyRightSide("mul", _localctx.exprA, "k", _localctx.formulas, _localctx.unif);
			                    ((WhileSegmentContext)_localctx).valid =  validateLeftVar(_localctx.exprA.getValue0(),_localctx.unif) && 
			                            validateLogBase("k", _localctx.unif);
			                }catch(Exception ex){
			                    ex.printStackTrace();
			                ...
			                //b=b/k
			                try{
			                    unifyRightSide("divF", _localctx.exprB, "k", _localctx.formulas, _localctx.unif);
			                ...
			                try{
			                    if(!_localctx.valid){
			                        ...
			                        unifyRightSide("add", _localctx.exprB, "const", _localctx.formulas, _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLeftVar(_localctx.exprB.getValue0(),_localctx.unif) && 
			                                validateConst("const", _localctx.unif);
			                    }
			                }catch(Exception ex){
			                ...
			                try{
			                    if(!_localctx.valid){
			                        ...
			                        unifyRightSide("divF", _localctx.exprB, "k1", _localctx.formulas, _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLeftVar(_localctx.exprB.getValue0(),_localctx.unif) && 
			                                validateLogBase("k1", _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLogBases(true);
			                    }
			                }catch(Exception ex){
			                    ((WhileSegmentContext)_localctx).valid =  false;
			                }
			                ...
			                try{
			                    if(!_localctx.valid){
			                        ...
			                        unifyRightSide("mul", _localctx.exprB, "k1", _localctx.formulas, _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLeftVar(_localctx.exprB.getValue0(),_localctx.unif) && 
			                                validateLogBase("k1", _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLogBases(false);
			                    }
			                }catch(Exception ex){
			                    ((WhileSegmentContext)_localctx).valid =  false;
			                }
			                ...
			                try{
			                    if(!_localctx.valid){
			                        ...
			                        unifyRightSide("sub", _localctx.exprA, "const", _localctx.formulas, _localctx.unif);
			                ...
			                try{
			                    if(!_localctx.valid){
			                        ...
			                        unifyRightSide("mul", _localctx.exprA, "k1", _localctx.formulas, _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLeftVar(_localctx.exprA.getValue0(),_localctx.unif) && 
			                                validateLogBase("k1", _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLogBases(true);
			                    }
			                ...
			                try{
			                    if(!_localctx.valid){
			                        ...
			                        unifyRightSide("divF", _localctx.exprA, "k1", _localctx.formulas, _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLeftVar(_localctx.exprA.getValue0(),_localctx.unif) && 
			                                validateLogBase("k1", _localctx.unif);
			                        ((WhileSegmentContext)_localctx).valid =  _localctx.valid && validateLogBases(false);
			                    }
	...
	public static class LeftVarContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterLeftVar(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitLeftVar(this);
		}
	}
	...
	public static class RightVarContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterRightVar(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitRightVar(this);
		}
	}
	...
	public static class ExprSequenceContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterExprSequence(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitExprSequence(this);
		}
	}
	...
	public static class VariableContext extends ParserRuleContext {
		public String var;
		public Token i;
		public TerminalNode IDENT() { return getToken(LogarithmicParser.IDENT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).enterVariable(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LogarithmicListener ) ((LogarithmicListener)listener).exitVariable(this);
		}
	}
