...
public interface LinearListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LinearParser#segmentSequence}.
	 * @param ctx the parse tree
	 */
	void enterSegmentSequence(@NotNull LinearParser.SegmentSequenceContext ctx);
	/**
	 * Exit a parse tree produced by {@link LinearParser#segmentSequence}.
	 * @param ctx the parse tree
	 */
	void exitSegmentSequence(@NotNull LinearParser.SegmentSequenceContext ctx);
	/**
	 * Enter a parse tree produced by {@link LinearParser#segment}.
	 * @param ctx the parse tree
	 */
	void enterSegment(@NotNull LinearParser.SegmentContext ctx);
	/**
	 * Exit a parse tree produced by {@link LinearParser#segment}.
	 * @param ctx the parse tree
	 */
	void exitSegment(@NotNull LinearParser.SegmentContext ctx);
	/**
